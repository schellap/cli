...
private:
    ...
    bool patch_mscorlib(const pal::string_t& packages_root, const pal::string_t& package_coreclr_dir);
    ...
    // Special entry for mscorlib in the deps entries
    int m_mscorlib_index;
