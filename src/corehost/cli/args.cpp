...
bool parse_arguments(const int argc, const pal::char_t* argv[], arguments_t& args)
{
    ...
    pal::realpath(&args.nuget_packages);
    pal::realpath(&args.dotnet_packages_cache);
    pal::realpath(&args.dotnet_servicing);
    pal::realpath(&args.dotnet_runtime_servicing);
    pal::realpath(&args.dotnet_home);
