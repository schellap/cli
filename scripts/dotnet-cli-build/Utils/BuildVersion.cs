...
namespace Microsoft.DotNet.Cli.Build
{
    public class BuildVersion
    {
        ...
        public string LatestHostSuffix => $"{LatestHostPrerelease}-{LatestHostBuildMajor}";

        // Full versions and package information.
        private string LatestHostVersion => $"{LatestHostVersionNoSuffix}-{LatestHostSuffix}-00";
        private string LatestHostFxrVersion => $"{LatestHostFxrVersionNoSuffix}-{LatestHostSuffix}-00";
        public  string LatestHostPolicyVersion => $"{LatestHostPolicyVersionNoSuffix}-{LatestHostSuffix}-00";
